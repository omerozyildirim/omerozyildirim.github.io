...
// Other methods
	this.resolve = function(){
		...
		var a = (Math.pow(access_points[1].getd(), 2) - Math.pow(access_points[2].getd(), 2) - Math.pow(access_points[1].getx(), 2) + Math.pow(access_points[2].getx(), 2) - Math.pow(access_points[1].gety(), 2) + Math.pow(access_points[2].gety(), 2)) / 2;
		var b = (Math.pow(access_points[1].getd(), 2) - Math.pow(access_points[0].getd(), 2) - Math.pow(access_points[1].getx(), 2) + Math.pow(access_points[0].getx(), 2) - Math.pow(access_points[1].gety(), 2) + Math.pow(access_points[0].gety(), 2)) / 2;
		// y -> x
		...
		customer_positions[1].setx(x); customer_positions[1].sety(y);
		customer_positions[1].sete(Math.sqrt( Math.pow((customer_positions[0].getx() - customer_positions[1].getx()), 2) + Math.pow((customer_positions[0].gety() - customer_positions[1].gety()), 2)));
		// x -> y
		/*var x = (a - y * (access_points[2].gety() - access_points[1].gety())) / (access_points[2].getx() - access_points[1].getx());
		var y = (b * (access_points[2].getx() - access_points[1].getx()) - a * (access_points[0].getx() - access_points[1].getx())) / ((access_points[0].gety() - access_points[1].gety()) * (access_points[2].getx() - access_points[1].getx()) - (access_points[2].gety() - access_points[1].gety()) * (access_points[0].getx() - access_points[1].getx()));
