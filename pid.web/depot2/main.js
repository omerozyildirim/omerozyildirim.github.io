function cbmandt(){
	if (form1.mandt.checked)
		form1.timestep.disabled = false;
	else
		form1.timestep.disabled = true;
}
...
function run(){
	...
	if (form1.mandt.checked)
		dt = parseFloat(document.form1.timestep.value);
	else{
		dt = 0.01;
	...
	if (document.form1.chart1.value == "pvp"){
		...
		if (document.form1.spmode.value == "step")
			series2.push([document.form1.delay.value, document.form1.levelpc.value]);
		...
		if (document.form1.chart1.value == "pv"){
			...
			if (document.form1.spmode.value == "step")
				series2.push([document.form1.delay.value, document.form1.levelpc.value * document.form1.height.value / 100.0]);
		...
		if (document.form1.chart2.value == "inp_outp"){
			...
			if (document.form1.chart2.value == "in_out"){
				...
				if (document.form1.chart2.value == "err"){
					series5.push([time, ctr1.geterror()]); // Controller error
				}
		tank1.iterate(dt);
		ctr1.iterate(dt);
	}
